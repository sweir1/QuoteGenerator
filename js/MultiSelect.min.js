        ...
        if (!this.options.data.length) {
            ...
            for (let i = 0; i < options.length; i++) {
                this.options.data.push({
                    ...
                    i18n: options[i].getAttribute("data-i18n"),
                });
            }
        }
        this.options.placeholder = i18next.t("label.languagePlaceholder");
    ...
    _template() {
        ...
        for (let i = 0; i < this.data.length; i++) {
            optionsHTML += `
                <div class="multi-select-option${this.selectedValues.includes(this.data[i].value) ? " multi-select-selected" : ""}" data-value="${this.data[i].value}">
                    ...
                    <span class="multi-select-option-text" data-i18n="${this.data[i].i18n}">${this.data[i].text}</span>
                </div>
            `;
        }
        let selectAllHTML = "";
        if (this.options.selectAll === true || this.options.selectAll === "true") {
            selectAllHTML = `<div class="multi-select-all">
                <span class="multi-select-option-radio"></span>
                <span class="multi-select-option-text">${i18next.t("label.selectAll") || "Select all"}</span>
            </div>`;
        }
        let template = `
            <div class="multi-select ${this.name}"${this.selectElement.id ? ' id="' + this.selectElement.id + '"' : ""} style="${this.width ? "width:" + this.width + ";" : ""}${this.height ? "height:" + this.height + ";" : ""}">
                ...
                <div class="multi-select-header" style="${this.width ? "width:" + this.width + ";" : ""}${this.height ? "height:" + this.height + ";" : ""}">
                    <span class="multi-select-header-placeholder" data-i18n="label.languagePlaceholder">${this.options.placeholder}</span>
                </div>
    ...
    _eventHandlers() {
        ...
        this.element.querySelectorAll(".multi-select-option").forEach((option) => {
            option.onclick = () => {
                ...
                if (!this.element.querySelector(".multi-select-header-option")) {
                    headerElement.querySelector(".multi-select-header-placeholder") || headerElement.insertAdjacentHTML("afterbegin", `<span class="multi-select-header-placeholder" data-i18n="label.languagePlaceholder">${i18next.t("label.languagePlaceholder")}</span>`);
                } else {
